...
cursor: pointer;
    ...
    <body class="antialiased">
        ...
        <div style="background-color:silver" class="relative flex items-top justify-center min-h-screen  sm:items-center py-4 sm:pt-0">


            <div class="con">
                <h1 style="color:rgb(0, 71, 251)">Online Library</h1>
                @if (Route::has('login'))
                <div >
                    @auth
                    <div>
                    ...
                    @else
                    <div class="a_con">
                        <a href="{{ route('login') }}" class=" ml-2 text-sm text-gray-700 dark:text-gray-500 underline">Log in</a>
                    </div>
